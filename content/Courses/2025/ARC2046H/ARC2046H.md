...
- Interaction Diagram
	...
	- $C_r=\phi\cdot A \cdot f_y \cdot (1 + \lambda^\text{2n})^\frac{-1}{n}$
		...
		- $\lambda = \sqrt{fy/fcr}$
			- $= \frac{kL}{r}\cdot\sqrt{\frac{fy}{\pi^2E}}$
...
| ---------------------------------------- | --------------------------------------- | ---------------------------------------- | ------------------------------------ |
| <span style="color:purple">Purple</span> | <span style="color:magenta">Pink</span> | <span style="color:orange">Orange</span> | <span style="color:cyan">Blue</span> |
