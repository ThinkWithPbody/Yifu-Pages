...
$K_{ZCb}=6.3(bL_d)^{-0.13}<=1.3=1.0518$
$K_{ZCd}=6.3(dL_b)^{-0.13}<=1.3=1.1167$


$K_{Cb}=(1.0+\frac{F_C \times K_{ZCb} \times {C_{Cb}}^3}{35 \times E_{05} \times K_{SE} \times K_T})^{-1}$
$K_{Cb}=(1.0+\frac{7.5 \times 1.0518 \times 2,242.43}{35 \times 5500 \times 1 \times 1})^{-1}=0.91584$
$K_{Cd}=(1.0+\frac{7.5 \times 1.1167 \times 8,930.29}{35 \times 5500 \times 1 \times 1})^{-1}=0.72018$

$P_{rb}(kN)=0.8 \times 7.5 \times 46031 \times 1.0518 \times 0.91584 \div 1000=266.0$
$P_{rd}(kN)=0.8 \times 7.5 \times 46031 \times 1.1167 \times 0.72018 \div 1000=222.1$
